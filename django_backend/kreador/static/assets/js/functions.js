    ...
    // END: Video player
		...
		darkMode: function () {
			...
			var changeThemeToDark = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '/static/assets/css/style-dark-rtl.html');
				} else {
			...
			var changeThemeToLight = () => {
				...
				if(dir == 'rtl') {
						style.setAttribute('href', '/static/assets/css/style-rtl.html');
				} else {
			...
			if (e.isVariableDefined(e.select(".dropzone-default"))) {
				e.selectAll(".dropzone-default").forEach((e => {
					const a = e.dataset.dropzone ? JSON.parse(e.dataset.dropzone) : {},
						b = {
							// Change this URL to your actual image upload code
